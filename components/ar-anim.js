        ...
        <div class="anim__container">
          ...
          <div class="background-button">
              <div class="buttons mb-5">
                  <button class="btn ios-btn-primary" @click="handleLogin">Iniciar Sesión</button>
                  <primary-button-block class="button-facebook btnSecundary mt-3" v-if="os != 'ios'"
                  ...
                  <primary-button-block class="button-apple btnSecundary mt-3" v-if="os == 'ios'" :field="buttonToApple"
                      @clicked-button="requestApple">
                  </primary-button-block>

                  <button class="btn ios-btn-primary" @click="handleRegister"><span>Registrate</span></button>
              </div>
          </div>
      </div>
    `

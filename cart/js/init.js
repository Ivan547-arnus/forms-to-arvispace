...
let content = new Vue({
    ...
    methods:{
        ...
        requestProductos(){
            ...
            let service = this.initialize.use_mode == "testing" ? "https://arvispace.com/serviciosASARAmbientePruebas/Productoscaracteristicas.php" : "https://arvispace.com/serviciosASAR/Productoscaracteristicas.php"; 
            let tempProductos = [];
        ...
        requestAsentamiento(){
            let service = this.initialize.use_mode == "testing" ? "https://arvispace.com/serviciosASARAmbientePruebas/cpAsentamientoEstados.php" : "https://arvispace.com/serviciosASAR/cpAsentamientoEstados.php"; 
            let form = new FormData();
        ...
        insertOrder(responseBank,formSubmit){

            let service = this.initialize.use_mode == "testing" ? "https://arvispace.com/serviciosASARAmbientePruebas/insertarPedido.php" : "https://arvispace.com/serviciosASAR/insertarPedido.php";
